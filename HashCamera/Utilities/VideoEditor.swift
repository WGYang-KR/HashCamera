...
class VideoEditor {
    ...
    private func rotateVideoUsingReaderWriter(
        ...
        let outputURL = FileManager.default.temporaryDirectory.appendingPathComponent(UUID().uuidString).appendingPathExtension(fileExtension)
        ...
        exportSession.outputFileType = (fileExtension == "mp4") ? .mp4 : .mov
